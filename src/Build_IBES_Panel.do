...
** Data Source (WRDS)
* IBES / IBES Academic / Summary History / Summary Statistics
* US file (Measures), Fiscal Year 1 (Forecast Period Indicator)
* When downloading data from IBES, ensure that the following variables are included:
