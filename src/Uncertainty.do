...
estpost sum sale_tr at_tr emp_tr age life numana lev_tr strt_tr fdis1_tr fdis2_tr fe1_tr fe2_tr fe3_tr if lowdummy==1, d
eststo low 
estpost sum sale_tr at_tr emp_tr age life numana lev_tr strt_tr fdis1_tr fdis2_tr fe1_tr fe2_tr fe3_tr if lowdummy==0, d
eststo high 
esttab  low high ///
using $mypath/FigureTable/desc_uncertainty_sub.tex, replace ///
...
using $mypath/FigureTable/reg_MK3.tex, replace  ///
...
esttab fe3_mean_hp_low_dgdp fe3_mean_hp_high_dgdp fe3_sdev_hp_low_dgdp fe3_sdev_hp_high_dgdp fe3_skew_hp_low_dgdp fe3_skew_hp_high_dgdp ///
    using $mypath/FigureTable/reg_MK4.tex, replace  ///
star(* 0.10 ** 0.05 *** 0.01) nogaps ///
depvars beta(%6.3f) legend noabbrev style(tex) ///
label stats(N r2 , fmt(%9.0g %5.0g) ///
labels(Observations R^2 )) t noconstant ///
...
set graph on
graph combine MK1mu MK2mu MK3mu MK4mu, title("") graphregion(color(white)) name(comboMK3, replace)
graph export $mypath/FigureTable/comboMK3.png, as(png) replace


graph combine MK1sd MK2sd MK3sd MK4sd, title("") graphregion(color(white)) name(comboMK4, replace)
graph export $mypath/FigureTable/comboMK4.png, as(png) replace
set graph off
